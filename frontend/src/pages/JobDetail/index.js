...
export default function JobDetail(props) {
  ...
  const initJobData = {
    ...
    requirement:
      "asdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdas",
    status: "OPEN",
  ...
  const applyBtnHandler = async () => {
    await axios
      .post(
        `http://127.0.0.1:8300/application-record`,
        {
          sid: uid,
    ...
    <div className="col-sm-10 col-md-8 col-lg-8 main-container">
      <div className="d-flex justify-content-around ">
        ...
        <div className="d-flex justify-content-around">
          <div className="d-flex justify-content-right num_left-style p-1">
            <text>
              <span className=""> Required : </span> {jobData.positionLeft}
            </text>
          </div>
          <div className="d-flex justify-content-right num_left-style p-1">
            <text>left</text>
      ...
      <div className="d-flex flex-column justify-content-center description-container-style p-1 ">
        ...
        <div className=" p-1 body-style">
          <text>{jobData.responsibility}</text>
        </div>
        <div className="d-flex justify-content-left p-1 topic-style">
          <text>Requirement :</text>
        </div>
        <div className="p-1 body-style">
          <text>{jobData.requirement}</text>
        </div>
        <div className="d-flex justify-content-left p-1 body-style">
          <text>
      ...
      {AuthState.login_type === "STUDENT" ? (
        <div className="d-flex justify-content-start p-2 col-sm-10 col-md-8 col-lg-8 ">
